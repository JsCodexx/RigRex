  ...
  <div class="wrapper">
    ...
    <article class="details">
      ...
      <p>
        ...
        regelmäßigen Abständen wieder durchzulesen.<br />
      ...
      <h3>Reichweitenmessung & amp; Cookies</h3>
      <p>
        ...
        werden. <br />
        Ihr Browser greift auf diese Dateien zu. Durch den Einsatz von Cookies
      ...
      <p>
        ...
        einverstanden, das Ihr Daten (insbesondere Telefonummer und Name) an
        Facebook und WhatsApp weitergegeben werden. WhatsApp Inc. teilt
        Informationen weltweit, sowohl intern mit den Facebook-Unternehmen als
        auch extern mit Unternehmen, Dienstleistern und Partnern und außerdem
        mit jenen, mit denen du weltweit kommunizierst. Deine Informationen
        können für die in dieser Datenschutzrichtlinie
        https://www.whatsapp.com/legal/#privacy-policy beschriebenen Zwecke
        beispielsweise in die USA oder andere Drittländer übertragen oder
        übermittelt bzw. dort gespeichert und verarbeitet werden.
      </p>
      ...
      <p>
        ...
        Ihr Name, Ihre E-Mail-Adresse und Telefonnummer. Diese Website können
        ...
        Rückschlüsse auf Ihre Person nicht möglich. Wir verarbeiten
        personenbezogene Daten wie Vorname, Nachname, IP-Adresse,
        ...
        ausdrücklicher Erlaubnis der betreffenden Nutzer und unter Einhaltung
        der geltenden Datenschutzbestimmungen. Die Verarbeitung der
        personenbezogenen Daten erfolgt aufgrund unseres berechtigten Interesses
        zur Erfüllung unserer vertraglich vereinbarten Leistungen und zur
      ...
      <p>
        ...
        ein Interesse an der Identität des Kommentar- bzw. Beitragsautors haben.
      </p>
      ...
      <p>
        ...
        den USA gesandt und dort gespeichert. Google LLC hält das europäische
        Datenschutzrecht ein und ist unter dem Privacy-Shield-Abkommen
        zertifiziert:
        https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI& amp;status=Active
        ...
        Alternativ verhindern Sie mit einem Klick auf diesen Link Google
        Analytics deaktivieren, dass Google Analytics innerhalb dieser Website
      ...
      und dem Betrieb unseres Online-Angebotes (im Sinne des Art. 6 Abs. 1 lit.
      f. DSGVO), verwendet diese Website das Facebook-Social-Plugin, welches von
      ...
      den folgenden Link: https://developers.facebook.com/docs/plugins/ Facebook
      Inc. hält das europäische Datenschutzrecht ein und ist unter dem
      Privacy-Shield-Abkommen zertifiziert:
      https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC&
      amp;status=Active Das Plugin stellt eine direkte Verbindung zwischen Ihrem
      ...
      Server der Facebook Inc. übermittelt. Informationen dazu finden Sie hier:
      ...
      an die Facebook Inc. übermittelt. Möchten Sie verhindern, dass die
      Facebook. Inc. diese Daten mit Ihrem Facebook-Konto verknüpft, loggen Sie
      sich bitte vor dem Besuch dieser Website bei Facebook aus und löschen Sie
      ...
      <p>
        ...
        über aktuelle Geschehnisse und Angebote informiert. Möchten Sie den
      ...
      <h3>Der Newsletterversand erfolgt durch Spanndecken Markowski</h3>
      <p>
      ...
      <p>
        ...
        info@spanndecken-hilden.de Unsere Webseite benutzt einen Dienst der
        Matelso GmbH, Stuttgart. Wenn Sie auf einer von Matelso für uns
        geschalteten Rufnummer anrufen, werden Informationen zu dem Telefonat in
        einen von uns verwendeten Webanalysedienst (z.B. Google Analytics)
        übertragen. Matelso liest ferner von unserem Analysedienst gesetzte
        Cookies oder andere Parameter der von Ihnen besuchten Internetseite aus,
        zum Beispiel referrer, document path, remote user agent. Die
        entsprechenden Informationen werden gemäß unseren Weisungen von Matelso
        verarbeitet und auf Servern in der EU gespeichert. Nähere Informationen
        finden Sie auf: https://www.matelso.de/privacy. Sie können die
        Speicherung von Cookies durch eine entsprechende Einstellung Ihrer
        Browsersoftware verhindern; wir weisen Sie jedoch darauf hin, dass Sie
        in diesem Fall ggf. nicht sämtliche Funktionen dieser Webseite
